...
<body style="background-color:#00003a5c;">
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" style="color: white;" href="../manage-patient.php">BACK TO DETAILS</a>
                      </li>
                    </ul>
            ...
            <h2 style="text-align:center;color:white;">PATIENT ACCOUNT DETAILS</h2>
                <table class="table table-bordered table-dark" style="border: 2px solid black;">
                    ...
                    <tr>
                        ...
                        <td><a href="patient-account-update.php?email=<?php echo $row["email"];?>">EDIT</a></td>
                        <td><a href="patient-account-delete.php?email=<?php echo $row["email"];?>">DELETE</a></td>
                        </tr>
                        <?php
                            }
                          }
