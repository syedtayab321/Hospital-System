...
if(isset($_SESSION['username']))
{
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
 {
  ...
  { 
    ...
    $room_id=$room_row["ward_id"];
    $sql="INSERT INTO `patient`(`patientname`,`email`,`dieases`,`mobile`,`address`,`gender`,`doctor_id`,`ward_id`) VALUES ('$patname','$email','$dieases','$mobile','$address','$gender','$doctor_id','$room_id')";
...
<head>
    ...
    <script src="../../admin-portal/validation-js/patient-update.js"></script>
...
<div class="main">
        <div class="login-form">
            ...
            <div class="textt">
                <div class="back">
                    <a href="../patient-dashboard.php">GO BACK</a>
                </div>
            </div>
        </div>
    </div>
