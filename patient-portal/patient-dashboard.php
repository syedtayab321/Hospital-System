...
<body>
  ...
  <div class="login-section">
    ...
    <div class="patient">
         <div class="p1">
            <img src="../index/images/Tiny doctors and patients near hospital flat vector illustration.jpg" alt="" width="100%" height="100%">
         </div>
         <div class="p2">
            <h4>VIEW DETAILS</h4>
            <a href="main/view.php">CLICK HERE</a>
         </div>
    </div>

    <div class="patient">
      <div class="p1">
         <img src="../index/images/marcelo-leal-6pcGTJDuf6M-unsplash.jpg" alt="" width="100%" height="100%">
      </div>
      <div class="p2">
         <h4>MAKE APPOINMENT</h4>
         <a href="main/appointment.php">CLICK HERE</a>
      </div>
        </div>
  </div>
    </div>
